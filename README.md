...
K-Universe: Korean for English speakers
...
- **리포 이름**: `talkverselab/talkverse-ko` (이전 `talkverse-ko` — GitHub 리다이렉트되지만 remote를 새 이름으로 바꿔 두세요)
  ```
  git remote set-url origin https://github.com/talkverselab/talkverse-ko.git
  ```
